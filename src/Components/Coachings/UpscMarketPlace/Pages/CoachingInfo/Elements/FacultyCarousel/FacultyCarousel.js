...
import Courses from "./Faculties";
import CoursesDetailButton from "./FacultyBtn";
  ...
  return (
    <div
      style={{
        display: "flex",
        width: "100%",
        marginTop:navscreenWidth > 800 ? "40px" : "20px",
    ...
    >
      ...
      >
        ...
        <CoursesDetailButton prev={prev} next={next} />
      </div>
    </div>
  );
}
...
function Item({ group }) {
  ...
  return (
    <Grid
      container
      spacing={navscreenWidth > 800 ? 6 :2}
      style={{
